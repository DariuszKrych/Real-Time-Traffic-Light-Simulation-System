...
def change_states_of_cars(current_time, street_light_states, _memory={"is_moving": False, "elapsed_time": 0.0, "last_time": None, "chosen_paths": None}):
    speed = 300 
    start_y = -250 
    turn_start_y = 0 
    stop_line_y = -200 
    ...
    grey_path_function = _memory["chosen_paths"][0]
    orange_path_function = _memory["chosen_paths"][1]

    # Lead car
    grey_x, grey_y, grey_rotation = grey_path_function(drive_time, speed, start_y, turn_start_y)

    # Trailing car
    time_gap = 0.7 
    orange_drive_time = drive_time - time_gap
    orange_x, orange_y, orange_rotation = orange_path_function(orange_drive_time, speed, start_y, turn_start_y)

    # --- 5. CREATE CARS ---
    grey_car = ['car_body_1', grey_x, grey_y, grey_rotation, [100, 100, 100, 255]]
    orange_car = ['car_body_1', orange_x, orange_y, orange_rotation, [255, 165, 0, 255]] 

    return [grey_car, orange_car]
